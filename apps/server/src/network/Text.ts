  ...
  private async sendSuperMain() {
    ...
    return this.peer.send(
      Variant.from(
        ...
        `proto=228|choosemusic=audio/mp3/about_theme.mp3|active_holiday=0|wing_week_day=0|ubi_week_day=0|server_tick=${Math.floor(Date.now() / 1000)}|clash_active=0|drop_lavacheck_faster=1|isPayingUser=0|usingStoreNavigation=1|enableInventoryTab=1|bigBackpack=1|`,
