...
export class ItemHandler {
  ...
  public async handleItemUsage(peer: Peer, world: World, itemID: number, x: number, y: number): Promise<void> {
    ...
    switch (item.type) {
      ...
      case ActionTypes.MASK:
      case ActionTypes.FACE:
      case ActionTypes.HAIR:
      case ActionTypes.SHIRT:
      case ActionTypes.PANTS:
      case ActionTypes.FEET:
      case ActionTypes.HAND:
      case ActionTypes.NECKLACE:
      case ActionTypes.ANCES:
